...
const PricingMain = () => {
    ...
    return (
        <div className="pricing-main">
            ...
            <p className="pricing-info">Elevate Your Online Presence: Competitive Pricing for Exceptional Results</p>

            <div className="pricing-list pricing-list-white">

                {/* pricing box 1 */}
                <div className="pricing-box pricing-box-1 box-shadow">
                ...
                {/* pricing box 2 */}
                <div className="pricing-box pricing-box-dark pricing-box-2 box-shadow white">
                ...
                {/* pricing box 3 */}
                <div className="pricing-box pricing-box-3 box-shadow ">
